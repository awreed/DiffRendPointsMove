...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        #FF_GT.Beamformer(RP_GT, BI=range(0, RP_GT.numProj), soft=True)
        #BF_GT.display2Dscene(path='pics6/GT.png', show=False)
    ...
    for i in range(0, epochs):
        ...
        GT = BF_GT.Beamform(RP_GT, BI=batch, soft=True, z=z).abs().to(dev_1)
        ...
        #        plt.pause(.01)
                ...
                #path = "pics6/est" + str(i) + ".png"
                #BF_EST.Beamformer(RP_EST, BI=range(0, RP_EST.numProj), soft=True).abs()
                #BF_EST.display2Dscene(path=path, show=False)
